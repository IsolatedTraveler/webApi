...
<%  
        try{
			 ...
			 if(paramJson.containsKey("pageNumber")){//要 分页
				 ...
				 pageData.put("rows", JSONArray.fromObject(map).toString());
				 ...
				 map = NamedParameterJdbcTemplateQuery.queryMeta(namedParameterJdbcTemplate, sql, namedParameters);
				 //System.out.println(list.size()+"==="+sql);
				 JSONObject resultJson = new JSONObject();
				 resultJson.put("data", JSONArray.fromObject(map).toString());
				 resultJson.put("code","1");
				 resultJson.put("msg","");
